#import "GPUImageStraightGaussianSelectiveBlurFilter.h"
#import "GPUImageGaussianBlurFilter.h"
#import "GPUImageTwoInputFilter.h"

// http://stackoverflow.com/questions/16407840/rotate-gpuimagetiltshiftfilter-gpuimage

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kGPUImageStraightGaussianSelectiveBlurFragmentShaderString = SHADER_STRING
(
...
@implementation GPUImageStraightGaussianSelectiveBlurFilter
...
- (id)init;
{
    ...
    selectiveFocusFilter = [[GPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageStraightGaussianSelectiveBlurFragmentShaderString];
